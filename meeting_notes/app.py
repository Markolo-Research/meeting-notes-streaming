    ...
    def process_recording(self, audio_path: str, meeting_title: Optional[str] = None, user_notes: str = "") -> None:
        ...
        try:
            ...
            self.call_from_thread(
                self.notify, f"Loading Whisper {self.config.whisper_model} model...", severity="information"
            )
            ...
            self.call_from_thread(
                self.notify, "Transcribing audio (this may take a few minutes)...", severity="information"
            )
